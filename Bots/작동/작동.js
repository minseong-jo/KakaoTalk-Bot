...
function getWDWE() {
  // true : weekdays, false : weekends //

  var data = new Date();
  var day = data.getDay();

  if ((day == 1) || (day == 2) || (day == 3) || (day == 4) || (day == 5) == true) {
...
function send_alarm(param, param_2) {
    ...
    if (param_2 == "오전9시") {
      ...
      if (WDWE == true) {
        ...
        for (var i = 0; i < room_path.length; i++) {
          ...
          java.lang.Thread.sleep(500);
          var data_2 = JSON.parse(FileStream.read(room_path[i]));
          var room_id_r = data_2.room_id;
          var isBan = data_2.isBan;
          var onInfo = data_2.onInfo;
          var room_r = getRoomName(room_id_r);

          if ((isBan == false) && (onInfo == true) == true) {
